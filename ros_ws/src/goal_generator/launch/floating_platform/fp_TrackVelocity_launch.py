...
def generate_launch_description():
    ...
    goals_file_path = LaunchConfiguration(
        "goals_file", default=PathJoinSubstitution([goal_generator_dir, "config", "zero_g_lab", "velocity_trajectories", "circle.yaml"])
    )
    ...
    goals_file_path_arg = DeclareLaunchArgument(
        "goals_file_path",
        default_value=PathJoinSubstitution([goal_generator_dir, "config", "zero_g_lab","velocity_trajectories","circle.yaml"]),
