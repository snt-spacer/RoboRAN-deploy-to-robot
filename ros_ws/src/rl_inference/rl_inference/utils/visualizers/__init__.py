...
def generate_plots(data: pd.DataFrame, folder_path: str, task_name: str, robot_name: str, generate_videos:bool = False) -> None:
    ...
    # Generate the plots
    RVF.generate_plots(generate_videos)
    TVF.generate_plots(generate_videos)