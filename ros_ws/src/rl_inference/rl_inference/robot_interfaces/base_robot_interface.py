...
class BaseRobotInterface:
    ...
    def __init__(self, device: str = "auto", **kwargs) -> None:
        ...
        self._last_commands: torch.Tensor = None
    ...
    def build_logs(self) -> None:
        ...
        Logging robot related things, such as actions.
        """
        # Robot logs
        self._logs = {}
    ...
    def pre_kill_action(self) -> Any:
        """Return the pre kill action for the robot interface.
        
        This is the action called before the kill action. This is meant to send an action that does not completely
        shuts down the robot, but preps it for the kill action.
        """
    ...
    def kill_action(self) -> Any:
        ...
        This is the action called when the task is done. It is meant to stop the robot and prepping it for the next
        task.
        """
