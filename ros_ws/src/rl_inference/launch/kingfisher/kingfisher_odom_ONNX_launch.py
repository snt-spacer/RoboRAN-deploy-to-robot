...
def generate_launch_description():
    ...
    inference_runner_name = LaunchConfiguration("inference_runner_name", default="ONNX")
    ...
    max_run_time = LaunchConfiguration("max_run_time", default=20)
    dt = LaunchConfiguration("dt", default=1/20.0)
    terminate_on_completion = LaunchConfiguration("terminate_on_completion", default=False)
    nn_checkpoint_path = LaunchConfiguration("nn_checkpoint_path", default="/RANS_DeployToRobot/models/kingfisher_direct.onnx")
    ...
    nn_checkpoint_path_arg = DeclareLaunchArgument(
        "nn_checkpoint_path",
        default_value="/RANS_DeployToRobot/models/kingfisher_direct.onnx",
