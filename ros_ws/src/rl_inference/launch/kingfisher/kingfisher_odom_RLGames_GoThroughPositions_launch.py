...
def generate_launch_description():
    ...
    nn_checkpoint_path = LaunchConfiguration("nn_checkpoint_path", default="/RANS_DeployToRobot/models/RLGames/GoThroughPositions/2025-02-26_08-47-06/nn/kingfisher_direct.pth")
    nn_log_dir = LaunchConfiguration("nn_log_dir", default="/RANS_DeployToRobot/models/RLGames/GoThroughPositions/2025-02-26_08-47-06")
    ...
    nn_checkpoint_path_arg = DeclareLaunchArgument(
        "nn_checkpoint_path",
        default_value="/RANS_DeployToRobot/models/RLGames/GoThroughPositions/2025-02-26_08-47-06/nn/kingfisher_direct.pth",
        description="The path to the neural network checkpoint.",
    )
    nn_log_dir_arg = DeclareLaunchArgument(
        "nn_log_dir",
        default_value="/RANS_DeployToRobot/models/RLGames/GoThroughPositions/2025-02-26_08-47-06/",
