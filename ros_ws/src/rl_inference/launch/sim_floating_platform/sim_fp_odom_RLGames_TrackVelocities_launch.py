...
def generate_launch_description():
    ...
    robot_interface_name = LaunchConfiguration("robot_interface_name", default="VirtualFloatingPlatform")
    ...
    nn_checkpoint_path = LaunchConfiguration("nn_checkpoint_path", default="/RANS_DeployToRobot/models/rl_games/2025-03-06_12-20-31/nn/last_FloatingPlatform-TrackVelocities_ep_500_rew__270.0161_.pth")
    nn_log_dir = LaunchConfiguration("nn_log_dir", default="/RANS_DeployToRobot/models/rl_games/2025-03-06_12-20-31")
    ...
    robot_interface_name_arg = DeclareLaunchArgument(
        ...
        default_value="VirtualFloatingPlatform",
    ...
    nn_checkpoint_path_arg = DeclareLaunchArgument(
        "nn_checkpoint_path",
        default_value="/RANS_DeployToRobot/models/rl_games/2025-03-06_12-20-31/nn/last_FloatingPlatform-TrackVelocities_ep_500_rew__270.0161_.pth",
        description="The path to the neural network checkpoint.",
    )
    nn_log_dir_arg = DeclareLaunchArgument(
        "nn_log_dir",
        default_value="/RANS_DeployToRobot/models/rl_games/2025-03-06_12-20-31",
