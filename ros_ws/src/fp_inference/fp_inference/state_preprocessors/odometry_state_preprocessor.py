...
class OdometryStatePreProcessor(Registerable, BaseStatePreProcessor):
    ...
    The OdometryStatePreProcessor processes odometry messages from the robot. it uses the conventional
    Odometry message, where the velocities are in the body frame. It overrides the base class to provide the linear
    velocities in the world frame as well.
    """
    ...
    def update_state_ROS(self, odometry: Odometry, **kwargs) -> None:
        ...
        The odometry message provides the pose in the world
        frame, and the velocities in the body frame.
        """
