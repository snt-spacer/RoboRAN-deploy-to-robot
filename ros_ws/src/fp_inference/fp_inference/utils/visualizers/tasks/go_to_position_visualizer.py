...
class GoToPositionVisualizer(BaseTaskVisualizer, Registerable):
    ...
    def plot_trajectory(self) -> None:
        ...
        ax.plot(self._data['position_world.x.m'], self._data['position_world.y.m'], label='Robot Trajectory', color='royalblue')
        ax.set_xlabel('X (m)')
        ax.set_ylabel('Y (m)')
        ...
        plt.scatter(target_pos_x, target_pos_y, color='r', facecolor=None, label='Goal Position')
        ax.axis('equal')
        ax.legend()
    ...
    def plot_trajectory_with_heading(self) -> None:
        ...
        ax.quiver(self._data['position_world.x.m'].iloc[idx], self._data['position_world.y.m'].iloc[idx], 
                  ...
                  color='royalblue', label='Robot Heading')
        ax.axis('equal')
    ...
    def make_trajectory_video(self):
        ...
        def update_trajectory(i):
            ax.clear()
            ax.plot(x_pos[:i], y_pos[:i], label='Robot Trajectory', color='b')
            ax.plot(target_pos_x, target_pos_y, 'ro')
